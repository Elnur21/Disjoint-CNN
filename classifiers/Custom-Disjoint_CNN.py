...
from tensorflow.keras.layers import Input, SeparableConv1D, Conv2D, BatchNormalization, ELU, Permute, MaxPooling2D
...
class Classifier_Disjoint_CNN:
    ...
    def build_model(self, input_shape, nb_classes):
        ...
        conv1 = SeparableConv1D(64, (8, 1), strides=1, padding="same", kernel_initializer='he_uniform')(X_input)
